...
<div style="text-align: center;">
    <img src="assets/logo.jpeg" alt="SafeHaven Cybersecurity Main Logo" style="width: 65%;">   
</div>

<!-- Large Overview Image with Full Width (Max 800px) -->
<img src="assets/image.jpg" alt="ISMS Overview - Secure and Compliant" style="width: 100%; max-width: 800px; display: block; margin: auto;">

<!-- Small Logo Above Address at 15% Size, Aligned Left -->
<div style="display: flex; align-items: center; margin-top: 20px;">
    <img src="assets/logo.jpeg" alt="SafeHaven Cybersecurity Small Logo" style="width: 15%; margin-right: 10px;">
    <p>
        **SafeHaven Cybersecurity**<br>
